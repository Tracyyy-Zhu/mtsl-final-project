...
singularity exec --nv --bind /scratch/bc3088/ --overlay /scratch/bc3088/overlay-25GB-500K.ext3:rw /scratch/bc3088/cuda11.4.2-cudnn8.2.4-devel-ubuntu20.04.3.sif /bin/bash -c "source /ext3/env.sh; conda activate; python /scratch/bc3088/mstats/test.py"